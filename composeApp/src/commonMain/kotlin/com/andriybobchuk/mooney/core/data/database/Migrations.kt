...
/**
 * Every registered migration in the order they must be applied.
 *
 * Both `DatabaseFactory.android.kt` and `DatabaseFactory.ios.kt` should
 * loop `.addMigrations(*ALL_MIGRATIONS.toTypedArray())` off this list —
 * it's the single source of truth. Adding a new migration means (1)
 * bump `@Database(version)`, (2) declare `MIGRATION_N_N+1`, (3) append
